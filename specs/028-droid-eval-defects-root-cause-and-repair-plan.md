...
> Уточнение требований: [план 029](029-cross-harness-defects-and-observable-fallback.md)
> заменяет рекомендации ниже о запрете quota fallback и автоматической
> невалидности смешанного запуска. Fallback разрешён с обязательным наблюдением
> и раскрытием в отчёте. Факты инцидента и остальные первопричины сохраняются.
