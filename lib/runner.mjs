...
async function callDriver(profile, args, options) {
  ...
  return await new Promise((resolve, reject) => {
    const child = spawn(executable, [script, ...driverProfileArgs(profile, args), "--json"], { cwd: options.cwd, env: { ...process.env, ...options.env }, stdio: ["ignore", "pipe", "pipe"] }); let stdout = ""; let stderr = "";
