...
async function runCapacityProbe({ profile, attempt, projectRoot, runtimeRoot, probe, eventsFile, event }) {
  ...
  // A provider may return an eager marker despite the probe instruction.  The
  // probe measures concurrent occupancy, so never record capacity before the
  // declared hold window has elapsed from the fan-out launch.
