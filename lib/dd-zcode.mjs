...
export class AcpBridge {
  ...
  receive(line) {
    ...
    if (typeof message.params?.sessionId === "string" && message.params?.update?.sessionUpdate === "retry_state" && message.params.update.type === "failed") {
      this.providerErrors.set(message.params.sessionId, message.params.update);
    }
