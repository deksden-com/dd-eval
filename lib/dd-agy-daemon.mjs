...
async function dispatch(runtime, request) {
  ...
  if (request.operation === "session.prompt") { await runtime.start(params.sessionId ?? null); runtime.requireSessionIdentity(params.sessionId); return await runtime.prompt(params.prompt); }
