...
export class Runtime {
  ...
  async finishTurn(result) {
    ...
    if (current && Number.isInteger(result.num_turns) && Number.isInteger(current.resultFloor) && result.num_turns <= current.resultFloor) { await this.journal("stale_terminal_observed", { result }); return; }
