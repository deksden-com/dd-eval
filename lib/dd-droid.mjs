...
export class DroidRuntime {
  ...
  async closeTree(cancel = false) {
    ...
    await this.save({ active_tree: false, cleanup: { settled: true, forced, observed_processes: this.ownedProcesses.length } });
