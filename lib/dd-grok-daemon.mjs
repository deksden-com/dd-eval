...
async function observeAcpToolCall(config, identity, message) {
  ...
  if (update?.sessionUpdate !== "tool_call" || !sessionId || typeof command !== "string" || !/\bdd-flow\b/.test(command)) return;
