...
> Исторический отчёт подготовки beta.56. После расследования cp-105 выявлены
> дополнительные дефекты; эта отметка готовности не распространяется на новый
> запуск. Текущий пакет исправлений и проверки — в
> [Fix 034](../specs/034-cp105-event-recovery-and-observability.md).
> Новые локальные изменения CLI/bridge ещё не опубликованы и не включены в pins ниже.
