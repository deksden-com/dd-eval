# Controller prompt: beta.3 initial SPECIFY pass
...
session registration or another RUN command first. The start response contains
the complete bounded work packet and the path to the semantic input template;
trust it and do not reread the embedded sources.
