...
Engine target: `dd-flow-cli@0.8.0-beta.19`.

Flow pack target: `3.2.0-vnext-protocolize-beta.7`.
...
same-session rerun. Beta.7 adds the complete delivery contract and is prepared
