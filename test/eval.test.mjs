...
test("case pins its input checkpoint and exact engine without Session starter state", async () => {
  ...
  assert.equal(loaded.inputCheckpoint.value.id, "cp-075-task-priority-supplemental-evidence-flow-4-0-6-engine-0-9-0-beta-24");
  ...
  assert.equal(loaded.inputCheckpoint.value.flow_pack.engine.artifact_sha256, "5ec4a3554b9231673301feaf299082f3ee4fee48b20fa0b0f096b8053a8e7c69");
